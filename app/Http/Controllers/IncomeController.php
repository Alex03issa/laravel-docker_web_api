...
class IncomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            $latestDate = Income::where('account_id', $accountId)->max('date');

            $dateFrom = $validated['dateFrom'] ?? ($latestDate ?? now()->subDays(7)->format('Y-m-d'));
     ...
     */
    public function localIncomes(Request $request)
    {
